          ...
          >
            <div className="rounded-2xl border border-white/10 bg-[#111] p-6 shadow-2xl">
              <div className="flex items-center justify-between mb-5">
                <h2 className="text-lg font-semibold text-neutral-100">Add Item</h2>
                <button
                  onClick={handleClose}
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      disabled={scraping}
                      className="flex items-center gap-2 rounded-lg border border-indigo-500/40 bg-indigo-500/10 px-4 py-2.5 text-sm font-medium text-indigo-300 transition-colors hover:bg-indigo-500/20 disabled:opacity-60"
                    >
                      {scraping ? (
                ...
                <div>
                  ...
                  <select
                    {...register("listId")}
                    className="w-full rounded-lg border border-white/10 bg-[#1a1a1a] px-3 py-2.5 text-sm text-neutral-100 outline-none transition focus:border-indigo-500/60 focus:ring-1 focus:ring-indigo-500/40"
                  >
